...
$stmt->execute();
$pendingDeliveryMen = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
$stmt = $conn->prepare($sql);
$stmt->execute();
$activeDeliveryMen = $stmt->fetchAll(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($action === 'approve_delivery_man' && $userId > 0) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['error_message'] = "Error approving delivery man.";
        }
        ...
        if ($stmt->execute()) {
            $_SESSION['success_message'] = "Delivery man suspended successfully.";
        } else {
            $_SESSION['error_message'] = "Error suspending delivery man.";
        }
        ...
        if ($stmt->execute()) {
            $_SESSION['success_message'] = "Delivery man activated successfully.";
        } else {
            $_SESSION['error_message'] = "Error activating delivery man.";
        }
...
<head>
    ...
    <title>Delivery Men Management - Admin Dashboard</title>
    ...
    <style>
        ...
        .tab-buttons {
            display: none; /* Hide tab buttons since we only have delivery men here */
        }
        .tab-content {
            padding: 20px;
        }
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($deliveryMan['phone'] ?: 'N/A'); ?></td>
                ...
                <div class="section">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="7" class="text-center">No active delivery men found</td>
                            </tr>
                            <?php else: ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($deliveryMan['phone'] ?: 'N/A'); ?></td>
                                    <td>N/A</td>
                                    <td><?php echo intval($deliveryMan['total_deliveries']); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <?php endif; ?>
                                        <a href="delivery_man_details.php?id=<?php echo $deliveryMan['user_id']; ?>" class="btn btn-sm btn-info">View</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
