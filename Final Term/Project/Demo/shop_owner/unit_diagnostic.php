...
echo "<h1>Product Units Diagnostic</h1>";
echo "<p>This page shows all products in the database with their unit values to help debug unit selection issues.</p>";
...
echo "<li>pcs - Piece</li>";
echo "<li>pack - Pack</li>";
echo "<li>box - Box</li>";
