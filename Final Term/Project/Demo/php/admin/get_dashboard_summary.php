...
$vendorFunctionsPath = __DIR__ . '/vendor_functions.php';
...
// Get total vendors
$vendorsSql = "SELECT COUNT(*) as count FROM vendors";
$vendorsResult = fetchOne($vendorsSql);
$vendorStats['total'] = $vendorsResult ? $vendorsResult['count'] : 0;

// Get active vendors
$activeVendorsSql = "SELECT COUNT(*) as count FROM vendors WHERE status = 'active'";
$activeVendorsResult = fetchOne($activeVendorsSql);
$vendorStats['active'] = $activeVendorsResult ? $activeVendorsResult['count'] : 0;

// Get pending vendors
$pendingVendorsSql = "SELECT COUNT(*) as count FROM vendors WHERE status = 'pending'";
